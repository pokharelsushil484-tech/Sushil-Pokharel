...
import { ShieldCheck, User, MapPin, Globe, Mail, Phone, Video, CheckCircle, XCircle, Home, Lock, RefreshCw, Search } from 'lucide-react';
    ...
    <div className="min-h-screen bg-slate-50 dark:bg-[#020617] py-12 px-4 sm:px-6 font-sans">
        <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-center mb-8 gap-4">
                ...
                {currentUser ? (
                    <button onClick={() => onNavigate(View.DASHBOARD)} className="text-[10px] font-bold text-slate-500 hover:text-indigo-600 uppercase tracking-widest transition-colors bg-white dark:bg-slate-900 px-4 py-2 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">Dashboard</button>
                ) : (
